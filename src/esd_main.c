...
static bool __esd_check_valid_privilege_by_db(uid_t uid, const char *appid, const char *pkgid, const char *privilege_name)
{
	int ret = 0;
	bool has_privilege = false;
	...
	epc->privilege_name = (char *)privilege_name;
...
static int __esd_check_app_privileged_event(uid_t uid, const char *appid, const char *pkgid, const char *event_name)
{
	...
	if (privilege_name && !__esd_check_valid_privilege_by_db(uid, appid, pkgid, privilege_name)) {
